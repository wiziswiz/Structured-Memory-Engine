...
const DEFAULTS = {
  ...
  recall: { minScore: 0.4 },
  recallGating: { enabled: true, minMessageLength: 5 },
  autoInject: { enabled: true, maxTokens: 1500 },
  promote: { enabled: true, minValueScore: 0.72, maxCandidatesPerRun: 20 },
  domainLabels: {},
};
